...
class DynamicType {
   public:
    ...
    DynamicType(const DynamicType& other)
        : pct(other.pct), data(new double[2]) {
        (*pct)++;
    }
...
std::pair<bool, double> iteratorPAddOneChecker() {
    ...
    for (auto itA = a.begin(), tA = itA; itA != a.end();
         tA = ++itA, tB = ++itB) {
        if (*itA != *itB) {
            return std::make_pair(false, 0);
        }
...
static CheckerPair TEST_A[] = {
    std::make_pair("Push Series -> push_back operation testing...",
                   pushBackChecker),
    std::make_pair("Push Series -> push_front operation testing...",
                   pushFrontChecker),
    std::make_pair("Pop Series -> pop_back operation testing...",
                   popBackChecker),
    std::make_pair("Pop Series -> pop_front operation testing...",
                   popFrontChecker),
    ...
    std::make_pair("Visitation Series -> constantly at operation testing...",
                   constAtChecker),
    std::make_pair("Visitation Series -> [] operator testing...",
                   bracketChecker),
    std::make_pair("Visitation Series -> constantly [] operator testing...",
                   constBracketChecker),
    std::make_pair("Visitation Series -> front operation testing...",
                   frontChecker),
    std::make_pair("Visitation Series -> back operator testing...",
                   backChecker),
    std::make_pair("Iterator Series -> +n operator testing...",
                   iteratorAddNChecker),
    std::make_pair("Iterator Series -> -n operator testing...",
                   iteratorRedNChecker),
    std::make_pair("Iterator Series -> +=n operator testing...",
                   iteratorAddENChecker),
    std::make_pair("Iterator Series -> -=n operator testing...",
                   iteratorRedENChecker),
    std::make_pair("Iterator Serise: Prefix ++ operator testing...",
                   iteratorPAddOneChecker),
    std::make_pair("Iterator Series -> Prefix -- operator testing...",
                   iteratorPRedOneChecker),
    std::make_pair("Iterator Series -> Suffix ++ operator testing...",
                   iteratorSAddOneChecker),
    std::make_pair("Iterator Series -> Suffix -- operator testing...",
                   iteratorSRedOneChecker),
    std::make_pair("Iterator Series -> - operator testing...",
                   iteratorMinusOperatorChecker),
    std::make_pair("Iterator Series -> Iterator insert persistence testing...",
                   iteratorInsertPersistenceChecker),
    std::make_pair("Iterator Series -> Iterator erase persistence testing...",
                   iteratorErasePersistenceChecker),
    std::make_pair("Robustness Series -> Invalid visitation by []...",
                   errorBracketChecker),
    std::make_pair("Robustness Series -> Invalid visitation by at...",
                   errorAtChecker),
    std::make_pair("Robustness Series -> Invalid visitation by iterator...",
                   errorIteratorChecker),
    std::make_pair("Robustness Series -> Invalid insert operation...",
                   errorInsertChecker),
    std::make_pair("Robustness Series -> Invalid erase operation...",
                   errorEraseChecker),
    ...
    std::make_pair("Independence Series -> Copy constructor testing...",
                   copyConstructorChecker),
    std::make_pair("Independence Series -> Operator = testing...",
                   equalOperatorChecker),
    std::make_pair("Memory Series -> Memory leak testing...",
                   memoryLeakChecker),
    std::make_pair("Synthesis Series -> Comprehensive testing...",
                   synthesisChecker)};
